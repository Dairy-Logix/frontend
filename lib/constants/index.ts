...
export const TENANT_ROUTES = {
  ...
  DELIVERY_TRIP: (id: string) => `/deliveries/${id}`,
  DELIVERY_EXCEPTIONS: '/deliveries/exceptions',
  DELIVERY_STORE_PINS: '/deliveries/stores',
  DELIVERY_SETTINGS: '/deliveries/settings',
  ORDERS: '/orders',
